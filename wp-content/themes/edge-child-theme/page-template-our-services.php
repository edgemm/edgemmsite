...
<div id="pageHead">
	<h1><?php the_title(); ?></h1>
	<?php $page_description=g et_post_meta($post->ID, "_ttrust_page_description_value", true); ?>
	...
	<div id="content" class="clearfix full">
		...
		<div <?php post_class( 'clearfix'); ?>>
			...
			<ul id="filterNav" class="clearfix">
				<li><a href="#" id="online-servicesbutton">Digital</a>
				</li>
				<li><a href="#" id="media-buyingbutton">Media Buying</a>
				</li>
				<li><a href="#" id="creative-servicesbutton">Creative</a>
				</li>
			...
			<div id="public-relations">
				<div id="posts" class="full homeSection clearfix">
					<h3><span>Public Relations</span></h3>
...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		$('#media-buyingbutton').click(function() {
			goToByScroll('#media-buying');
			theend();
		});
		$('#creative-servicesbutton').click(function() {
			goToByScroll('#creative-services');
			theend();
		});
		...
		$('#online-servicesbutton').click(function() {
			goToByScroll('#online-services');
			theend();
		});
		$('#social-mediabutton').click(function() {
			goToByScroll('#social-media');
			theend();
		});
		$('#public-relationsbutton').click(function() {
			goToByScroll('#public-relations');
			theend();
		});
